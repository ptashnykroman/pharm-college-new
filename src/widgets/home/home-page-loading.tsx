        ...
        <div className="hero-viewport-height relative container mx-auto flex flex-col items-center justify-center px-4 pb-20 pt-28 md:px-6">
          <div className="flex max-w-[900px] flex-col items-center text-center">
            ...
            <div className="mt-8 w-full max-w-[90vw] xs:max-w-md">
              <div className="flex items-center gap-3 rounded-full border border-[rgba(255,255,255,0.15)] bg-[rgba(var(--primary-deep),0.4)] py-1 xs:py-1.5 pl-1.5 pr-2 backdrop-blur-sm">
