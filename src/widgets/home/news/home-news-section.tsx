      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            ...
            className="group flex max-w-[140px] items-center gap-2 truncate rounded-full border border-primary/20 bg-card px-5 py-2.5 text-sm font-semibold text-primary shadow-soft transition-bounce hover:-translate-y-0.5 hover:bg-primary hover:text-primary-foreground"
          >
            Усі новини
