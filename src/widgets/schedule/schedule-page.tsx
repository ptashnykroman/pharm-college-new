                ...
                <div key={degree.id}>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2 sm:gap-3">
                    {degree.groups.map((group) => (
                      <SmartLink
                        key={group.id}
                        className="rounded-[0.75rem] border border-primary/30 bg-white px-3 py-1 text-sm font-semibold text-foreground shadow-soft hover:bg-accent hover:text-primary sm:text-md"
                        href={group.href}
                      >
                        {group.name}
                      </SmartLink>
...
export function ScheduleLandingPageView({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-soft py-12 md:py-16">
      ...
      <div className="absolute top-12 left-0 h-72 w-72 rounded-full bg-primary-glow/10 blur-3xl" />
      <div className="absolute right-0 bottom-0 h-72 w-72 rounded-full bg-accent-gold/10 blur-3xl" />
