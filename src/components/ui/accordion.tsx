    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <PlusIcon
          ...
          className="pointer-events-none shrink-0 text-primary transition-transform duration-200 group-data-[state=open]/accordion-trigger:rotate-45"
        />
      </AccordionPrimitive.Trigger>
...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-(--radix-accordion-content-height) px-5 py-5 md:px-6",
          className
        )}
      >
        {children}
